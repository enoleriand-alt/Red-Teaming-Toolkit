...
* **Invoke-PSImage** is a tool to embeded a PowerShell script iin the pixels of a PNG file and generates a oneliner to execute. https://github.com/peewpw/Invoke-PSImage
